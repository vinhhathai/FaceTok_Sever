...
module.exports = {
  "/api/friend/reject/{requestId}": {
    put: {
      tags: ["Friend"],
      summary: "Từ chối lời mời kết bạn",
      description: "API này cho phép người dùng đang đăng nhập từ chối một lời mời kết bạn",
      security: [
        {
          bearerAuth: []
        }
      ...
      parameters: [
        {
          ...
          in: "path",
          required: true,
          description: "ID của lời mời kết bạn cần từ chối",
          schema: {
            type: "string"
          }
        }
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  path: {
                    type: "string",
                    example: "/api/friend/reject/invalidId"
                  },
                  timestamp: {
                    type: "string",
                    format: "date-time"
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  path: {
                    type: "string",
                    example: "/api/friend/reject/requestId"
                  },
                  timestamp: {
                    type: "string",
                    format: "date-time"
                ...
                properties: {
                  ...
                  error: {
                    ...
                    properties: {
                      code: {
                        type: "string",
                        example: "REJECT_FRIEND_REQUEST_FAILED"
                      },
                      message: {
                        type: "string",
                        example: "Lỗi khi từ chối lời mời kết bạn"
                      }
                    }
                  },
                  path: {
