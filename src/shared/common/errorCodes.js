...
const AUTH_ERRORS = {
    ...
    RESEND_OTP_FAILED: 'AUTH_RESEND_OTP_FAILED',
...
const USER_ERRORS = {
    ...
    UPDATE_THUMBNAIL_SAVING_FAILED: 'USER_UPDATE_THUMBNAIL_SAVING_FAILED',
    ...
    ERR_RETRIEVE_USERS_FAILED: 'USER_ERR_RETRIEVE_USERS_FAILED',
    ERR_RETRIEVE_STATISTICS_FAILED: 'USER_ERR_RETRIEVE_STATISTICS_FAILED',
    ERR_RETRIEVE_PROFILE_FAILED: 'USER_ERR_RETRIEVE_PROFILE_FAILED',
    ERR_BAN_USER_FAILED: 'USER_ERR_BAN_USER_FAILED',
    ERR_UNBAN_USER_FAILED: 'USER_ERR_UNBAN_USER_FAILED',
    ERR_DELETE_USER_FAILED: 'USER_ERR_DELETE_USER_FAILED',
    ERR_SEND_EMAIL_FAILED: 'USER_ERR_SEND_EMAIL_FAILED',
};
...
const FRIEND_ERRORS = {
    ...
    CANCEL_FRIEND_REQUEST_FAILED: 'FRIEND_CANCEL_REQUEST_FAILED',
    ...
    CHECK_RELATIONSHIP_FAILED: 'FRIEND_CHECK_RELATIONSHIP_FAILED',
};
...
const MESSAGE_ERRORS = {
    ...
    CREATE_ROOM_FAILED: 'MSG_CREATE_ROOM_FAILED',
};
...
const ANNOUNCEMENT_ERRORS = {
    ERR_CREATE_ANNOUNCEMENT_FAILED: 'ANNOUNCEMENT_CREATE_FAILED',
    ERR_RETRIEVE_ANNOUNCEMENTS_FAILED: 'ANNOUNCEMENT_RETRIEVE_FAILED',
    ERR_RETRIEVE_ANNOUNCEMENT_FAILED: 'ANNOUNCEMENT_RETRIEVE_ONE_FAILED',
    ERR_UPDATE_ANNOUNCEMENT_FAILED: 'ANNOUNCEMENT_UPDATE_FAILED',
    ERR_DELETE_ANNOUNCEMENT_FAILED: 'ANNOUNCEMENT_DELETE_FAILED',
    ERR_ANNOUNCEMENT_NOT_FOUND: 'ANNOUNCEMENT_NOT_FOUND',
};
